...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private static final float SCALE_STEP = 0.04f; // view叠加缩放的步长
    //缩放层叠效果
...
//                removeAllViewsInLayout();
    ...
    private void makeAndAddView(View child, int index) {
        ...
        child.layout(childLeft, childTop + 50, childLeft + w, childTop + 50 +h);
        // 缩放层叠效果
    ...
    private void adjustChildView(View child, int index) {
        ...
        if (index > -1 && index < MAX_VISIBLE) {
            ...
            Log.e("offsetTopAndBottomindex", yOffsetStep * multiple + "");
    ...
    private void adjustChildrenOfUnderTopView(float scrollRate) {
        ...
        if (count > 1) {
            ...
            for (; i < LAST_OBJECT_IN_STACK; i++, multiple--) {
                ...
                Log.e("offsetTopAndBottomss", offset - underTopView.getTop() + initTop + "");
